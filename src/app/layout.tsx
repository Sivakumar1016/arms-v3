...
export const metadata: Metadata = {
  ...
  keywords: ["sivaKumar", "sivaKumar M", "siva", "ARMS", "Arms-v3", "Academic", "Resource", "Management", "System", "armss", "sivakumar2001"],
  authors: [{ name: "SivaKumar" }, { url: "https://sivakumar-beta.vercel.app/" }],
  creator: "SivaKumar",
  metadataBase: new URL("https://sivakumar-beta.vercel.app/"),
  alternates: {
    canonical: '/',
  },
  robots: {
